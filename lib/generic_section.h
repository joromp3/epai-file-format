...
extern uint32_t epai_optional_section_parse_length(const char*);
...
extern epai_error_t epai_section_validate_blob(const char*, uint32_t);
extern epai_error_t epai_section_parse_blob(epai_section_t**, const char*, uint32_t);
extern epai_error_t epai_section_fill_blob(const epai_section_t*, char*, uint32_t);
extern epai_error_t epai_section_new_blob(const epai_section_t*, char**, uint32_t*);
extern uint32_t epai_section_parse_length(const char*);
